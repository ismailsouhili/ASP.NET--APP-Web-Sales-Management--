<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="OppType.aspx.cs" Inherits="AppWeb_Sales_Management.OppType" %>
            ...
            <div class="input-group">
                <div class="form-inline">              
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success ">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtStudentId" class="form-control" placeholder="Opportunity Type" required  CssClass="form-control" OnTextChanged="txtStudentId_TextChanged"/>
                            </td>                          
