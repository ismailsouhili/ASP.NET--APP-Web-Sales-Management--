<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Projects.aspx.cs" Inherits="AppWeb_Sales_Management.Projects" %>
        ...
        <div>
          ...
          <asp:GridView ID="GridView1" runat="server" 
            ...
            <asp:SqlDataSource ID="LibraryDb" runat="server" 
                ...
                UpdateCommand="UPDATE [Project_Table] SET [ProjectName] = @ProjectName, [Amount] = @Amount, [Revenue] = @Revenue, [Description] = @Description, [status] = @status, [LaunchDate] = @LaunchDate, [Duration] = @Duration, [ContactName] = @ContactName, [ContactMobile] = @ContactMobile, [Notes] = @Notes WHERE [ProjId] = @ProjId" OnSelecting="LibraryDb_Selecting" >
                <DeleteParameters>
